...
public class StaticCallLocation extends AbstractCallLocation {
  ...
  StaticCallLocation(final long siteId, final String memberName, final String memberDesc, final int memberMod, final int line,
      final String file, final long declaringType, final boolean isInInterface, final String mcOwner, final String mcName,
      final String mcDesc, int mcModifier) {
    super(siteId);
