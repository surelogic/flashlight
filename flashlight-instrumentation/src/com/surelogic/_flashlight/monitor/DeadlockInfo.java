...
public class DeadlockInfo {
  ...
  public DeadlockInfo(final Set<LockStack> lockOrders, final Set<Long> deadlocks, final Map<Long, String> names) {
  ...
  private void appendLockOrders(final StringBuilder b, final Set<LockStack> lockOrders) {
    final List<String> strs = new ArrayList<String>();
    for (LockStack stack : lockOrders) {
      String s = "";
      for (; stack.getLockId() != LockStack.HEAD; stack = stack.getParentLock()) {
