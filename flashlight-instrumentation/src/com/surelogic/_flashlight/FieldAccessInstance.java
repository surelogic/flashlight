...
abstract class FieldAccessInstance extends FieldAccess {
  ...
  FieldAccessInstance(final Object receiver, final long field, final long siteId, final PostMortemStore.State state) {
  ...
  public boolean equals(final Object o) {
    if (o instanceof FieldAccessInstance) {
      ...
      return this.getFieldId() == s.getFieldId() && this.f_receiver == s.getReceiver();
