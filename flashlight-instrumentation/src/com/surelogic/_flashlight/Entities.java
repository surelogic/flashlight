...
public final class Entities {
  ...
  private static void add(final String name, final String value, final boolean escape, final StringBuilder b) {
  ...
  private abstract static class AbstractTuple implements Tuple {
     ...
     * Get the value.
     */
    public final void appendName(final StringBuilder sb) {
      sb.append('&');
      sb.append(f_name);
      sb.append(';');
    }
  ...
  public void define(final String name, final String value) {
    assert name != null;
    assert value != null;
    final Tuple tuple = value.length() == 1 ? new CharValueTuple(name, value) : new StringValueTuple(name, value);
  ...
  public void defineStandardXML() {
    /*
     * define("amp", "&"); define("apos", "'"); define("gt", ">"); define("lt",
     * "<"); define("quot", "\"");
     */
    f_NameValue.add(new Tuple() {
      ...
      public void appendName(final StringBuilder sb) {
        if (lastMatch == null) {
