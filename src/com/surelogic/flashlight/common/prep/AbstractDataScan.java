...
public class AbstractDataScan extends DefaultHandler {
	...
	private final LongMap<SiteInfo> sites = useSitesCompatibility ? new LongMap<SiteInfo>()
			: null;
	...
	protected PreppedAttributes preprocessAttributes(final String eltName,
		...
		if (a != null) {
			...
			if (useSitesCompatibility) {
				if (EventType.findByLabel(eltName) == EventType.Static_CallLocation) {
