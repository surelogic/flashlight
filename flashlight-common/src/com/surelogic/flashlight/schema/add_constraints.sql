...
<<>>
--Needed to find happens-before events between two accesses
...
<<>>
ALTER TABLE "FLASHLIGHT"."FIELDASSIGNMENT" ADD CONSTRAINT "FA_FIELD_FK" FOREIGN KEY ("FIELD") REFERENCES "FLASHLIGHT"."FIELD" ("ID")
<<>>
ALTER TABLE "FLASHLIGHT"."FIELDASSIGNMENT" ADD CONSTRAINT "FA_RECEIVER_FK" FOREIGN KEY ("RECEIVER") REFERENCES "FLASHLIGHT"."OBJECT" ("ID")
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORE" ADD CONSTRAINT "FA_TARGET_FK" FOREIGN KEY ("TARGET") REFERENCES "FLASHLIGHT"."OBJECT" ("ID")
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORE" ADD CONSTRAINT "FA_TRACE_FK" FOREIGN KEY ("TRACE") REFERENCES "FLASHLIGHT"."TRACE" ("ID")
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORE" ADD CONSTRAINT "FA_THREAD_FK" FOREIGN KEY ("THREAD") REFERENCES "FLASHLIGHT"."OBJECT" ("ID")
<<>>
