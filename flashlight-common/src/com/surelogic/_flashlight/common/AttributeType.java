...
public enum AttributeType implements IAttributeType {
  ...
  METHODCALLNAME("method-call-name"),

  METHODCALLOWNER("method-call-owner"),

  METHODCALLDESC("method-call-desc"),

  METHODCALLMOD("method-call-mod"),
