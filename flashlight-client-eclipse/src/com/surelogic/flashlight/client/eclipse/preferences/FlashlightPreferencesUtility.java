...
public final class FlashlightPreferencesUtility {
    ...
    public static void initializeDefaultScope() {
        if (f_initializationNeeded.compareAndSet(true, false)) {
            ...
            EclipseUtility.setDefaultBooleanPreference(AUTO_PREP_LAUNCHED_RUNS,
                    true);
            ...
            EclipseUtility.setDefaultIntPreference(
                    DEADLOCK_GRAPH_SASH_LHS_WEIGHT, 40);
            EclipseUtility.setDefaultIntPreference(
                    DEADLOCK_GRAPH_SASH_RHS_WEIGHT, 60);
    ...
    public static final String AUTO_PREP_LAUNCHED_RUNS = PREFIX
            + "auto.prep.launched.runs";
    public static final String POSTMORTEM_MODE = PREFIX + "store.postmortem";

    public static final String DEADLOCK_GRAPH_SASH_LHS_WEIGHT = PREFIX
            + "deadlock.graph.sash.lhs.weight";
    public static final String DEADLOCK_GRAPH_SASH_RHS_WEIGHT = PREFIX
            + "deadlock.graph.sash.rhs.weight";
