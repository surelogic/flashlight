...
abstract class HappensBefore extends Event {
  ...
  public void parse(PreppedAttributes attributes) throws SQLException {
    ...
    if (nanoStart == ILLEGAL_ID || nanoEnd == ILLEGAL_ID || inThread == ILLEGAL_ID || trace == ILLEGAL_ID || site == ILLEGAL_ID) {
  ...
  abstract void parseRest(PreppedAttributes attributes, String id, long nanoStart, long nanoEnd, long inThread, long trace,
      long site) throws SQLException;
