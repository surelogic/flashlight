...
final class AfterUtilConcurrentLockReleaseAttempt extends UtilConcurrentLock {
  ...
  AfterUtilConcurrentLockReleaseAttempt(final boolean releasedTheLock, final Lock lockObject, final long siteId,
  ...
  public String toString() {
    ...
    addThread(b);
    addLock(b);
    Entities.addAttribute("released-the-lock", f_releasedTheLock ? "yes" : "no", b);
    b.append("/>");
    return b.toString();
  }
}
