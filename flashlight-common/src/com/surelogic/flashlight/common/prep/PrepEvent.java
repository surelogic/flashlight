...
public enum PrepEvent {
  ...
  READWRITELOCK("read-write-lock-definition"),

  SELECTEDPACKAGE("selected-package"),

  STATICCALLLOCATION("static-call-location"),

  SINGLETHREADEFIELD("single-threaded-field"),
  ...
  HAPPENSBEFORETHREAD("happens-before-thread"),

  HAPPENSBEFOREOBJECT("happens-before-obj"),

  HAPPENSBEFORECOLLECTION("happens-before-coll"),

  HAPPENSBEFOREEXEC("happens-before-exec");

  static Map<String, PrepEvent> map = new HashMap<>();
  ...
  public static PrepEvent getEvent(final String xml) {
    ...
    if (e == null) {
      throw new IllegalArgumentException(xml + " is not a recognized tag.");
    }
    return e;
  }
