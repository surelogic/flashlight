 ...
 * 
 * <p>
 * This class is based on the source code in
 ...
 * 
 * <p>
 * The branch management works because the JVM specification requires that no
 * <em>backwards</em> branches are taken when an uninitialized object is on the
 * stack.
 * 
 * <p>
 * This could be extended to track movement of objects into and out of local
 * variables, but I don't think it is worthwhile.
 */
final class ConstructorInitStateMachine extends MethodVisitor {
	private static enum AbstractObjects {
		THIS, OTHER
	}
	...
	private List<AbstractObjects> stackFrame = new ArrayList<AbstractObjects>();

	private final Map<Label, List<AbstractObjects>> branchMap = new HashMap<Label, List<AbstractObjects>>();
	...
	public void visitVarInsn(final int opcode, final int var) {
		if (!triggered) {
			...
			case Opcodes.DLOAD:
				...
				break;
			case Opcodes.ALOAD:
				pushValue(var == 0 ? AbstractObjects.THIS
						: AbstractObjects.OTHER);
				break;
			case Opcodes.ASTORE:
			case Opcodes.ISTORE:
			case Opcodes.FSTORE:
