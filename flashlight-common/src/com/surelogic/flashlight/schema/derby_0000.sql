...
<<>>
CREATE TABLE "FLASHLIGHT"."SITE" ("ID" BIGINT NOT NULL, "ATLINE" INTEGER NOT NULL, "INCLASS" BIGINT NOT NULL, "INFILE" VARCHAR(255) NOT NULL, "LOCATION" VARCHAR(255) NOT NULL, "METHODCALL" VARCHAR(255), "METHODSPEC" VARCHAR(1024), "METHODCLASS" BIGINT) 
<<>>
