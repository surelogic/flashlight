...
public final class InstrumentationConstants {
  ...
  public static final String FL_PROPERTIES_RESOURCE = FL_PACKAGE + "/fl.properties";

  private static final String FL_INSTRUMENTATION_FOLDER_NAME = "instrumentation";
  public static final String FL_PROJECTS_FOLDER_LOC = FL_INSTRUMENTATION_FOLDER_NAME + File.separator + "projects";
  public static final String FL_EXTERNAL_FOLDER_LOC = FL_INSTRUMENTATION_FOLDER_NAME + File.separator + "external";
  ...
  private static final String FL_LOG_FILE_NAME = "instrumentation" + OutputType.LOG.getSuffix();
  ...
  public static final String FL_APK_FOLDER_LOC = FL_INSTRUMENTATION_FOLDER_NAME + File.separator + "apk";
  public static final String FL_DECOMPILED_JAR_LOC = FL_INSTRUMENTATION_FOLDER_NAME + File.separator + "decompiled.jar";
  ...
  public static final String FL_FIELDS_RESOURCE = FL_PACKAGE + "/" + FL_FIELDS_FILE_NAME;
  ...
  public static final String FL_CLASS_HIERARCHY_FILE_LOC = FL_INSTRUMENTATION_FOLDER_NAME + File.separator
  ...
  public static final String FL_SITES_RESOURCE = FL_PACKAGE + "/" + FL_SITES_FILE_NAME;
  ...
  public static final String FL_HAPPENS_BEFORE_FILE_LOC = FL_INSTRUMENTATION_FOLDER_NAME + File.separator
      + FL_HAPPENS_BEFORE_FILE_NAME;

  public static final String FL_RUNTIME_LOG_LOC = "runtime" + OutputType.LOG.getSuffix();
  ...
  public static final String[] FL_STREAM_SUFFIXES = { FL_LOCK_SUFFIX, FL_ACCESS_SUFFIX, FL_OBJECT_SUFFIX, FL_INDIRECT_SUFFIX,
      FL_OTHER_SUFFIX };
  ...
  public static final String[] FL_PROPERTY_LIST = new String[] { FL_COLLECTION_TYPE, FL_CONSOLE_PORT, FL_DATE_OVERRIDE, FL_DEBUG,
      FL_DIR, FL_FIELDS_FILE, FL_CLASS_HIERARCHY_FILE, FL_OFF, FL_NO_SPY, FL_OUTPUT_PORT, FL_OUTPUT_TYPE, FL_OUTQ_SIZE,
      FL_POSTMORTEM, FL_RAWQ_SIZE, FL_REFINERY_OFF, FL_REFINERY_SIZE, FL_RUN, FL_RUN_FOLDER, FL_SITES_FILE, FL_ANDROID };
  ...
  /**
   * The maximum amount of time in nanoseconds before rotating to the next file.
   */
