...
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKINFO" ("LOCK" BIGINT NOT NULL, "TYPE" CHAR(1) NOT NULL,"INTHREAD" BIGINT NOT NULL, "COUNT" BIGINT NOT NULL, "DURATION" BIGINT NOT NULL, "AVERAGE" BIGINT NOT NULL, "INTRINSIC" CHAR(3), "JUC" CHAR(3), "MAXTYPES" BIGINT , "MAXPACKAGES" BIGINT)
<<>>
