...
<<>>
CREATE TABLE "FLASHLIGHT"."HAPPENSBEFORE" ("THREAD" BIGINT NOT NULL, "TARGET" BIGINT NOT NULL, "TRACE" BIGINT NOT NULL, "TS" TIMESTAMP NOT NULL, "IS_FROM" CHAR(1)  NOT NULL)
<<>>
-- ----------------------------------------------
