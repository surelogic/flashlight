...
<<>>
CREATE INDEX "FLASHLIGHT"."HAPPENSBEFORECOLLTARGET_TS_INDEX" ON "FLASHLIGHT"."HAPPENSBEFORECOLLTARGET" ("INTHREAD", "TS" DESC)
<<>>
CREATE INDEX "FLASHLIGHT"."HAPPENSBEFORESOURCE_TS_INDEX" ON "FLASHLIGHT"."HAPPENSBEFORESOURCE" ("INTHREAD", "TS")
<<>>
CREATE INDEX "FLASHLIGHT"."HAPPENSBEFORETARGET_TS_INDEX" ON "FLASHLIGHT"."HAPPENSBEFORETARGET" ("INTHREAD", "TS" DESC)
<<>>
-- ----------------------------------------------
