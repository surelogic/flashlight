...
public final class Configuration {
	...
	public final static Set<String> BLACKLISTED_CLASSES_DEFAULT = Collections
			.emptySet();

	public final static FieldFilter FILTER_FIELDS_DEFAULT = FieldFilter.NONE;
	public final static Set<String> FILTER_FIELDS_IN_PACKAGES_DEFAULT = Collections
			.emptySet();
	...
	Configuration(final String storeClassName,
			...
			final boolean rewriteInvokevirtual, final boolean rewritePutfield,
			final boolean rewriteGetfield, final boolean rewritePutstatic,
			final boolean rewriteGetstatic, final boolean rewriteArrayLoad,
			final boolean rewriteArrayStore,
			final boolean rewriteSynchronizedMethod,
			final boolean rewriteMonitorenter,
			final boolean rewriteMonitorexit, final boolean rewriteInit,
	...
	public boolean equals(final Object o) {
		...
		return this.storeClassName.equals(storeClassName)
				&& this.indirectUseDefault == other.indirectUseDefault
				&& compareFileLists(this.indirectAdditionalMethods,
						other.indirectAdditionalMethods)
	...
	private static boolean compareFileLists(final List<File> list1,
			final List<File> list2) {
		if (list1.size() != list2.size()) {
			return false;
		}
		try {
			final Set<File> canonical1 = makeCanonicalFileSet(list1);
			final Set<File> canonical2 = makeCanonicalFileSet(list2);
	...
	private static Set<File> makeCanonicalFileSet(final List<File> files)
			throws IOException {
		final Set<File> canonical = new HashSet<File>();
