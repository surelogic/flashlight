...
public class ObjectPhantomReference extends IdPhantomReference {
  /**
   * Map from an {@link Object} to its associated {@link ObjectPhantomReference}
  ...
  private static final RefFactory<Object, ObjectPhantomReference> f_factory = new AbstractRefFactory<Object, ObjectPhantomReference>() {
    public ObjectPhantomReference newReference(final Object o, final ReferenceQueue q, final long id) {
  ...
  protected ObjectPhantomReference(final Object referent, final ReferenceQueue q, final long id) {
    super(referent, q, id);
