...
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORE" ADD CONSTRAINT "FA_TARGET_FK" FOREIGN KEY ("TARGET") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORE" ADD CONSTRAINT "FA_TRACE_FK" FOREIGN KEY ("TRACE") REFERENCES "FLASHLIGHT"."TRACE" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORE" ADD CONSTRAINT "FA_THREAD_FK" FOREIGN KEY ("INTHREAD") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORE" ADD CONSTRAINT "FA_SOURCE_FK" FOREIGN KEY ("INTHREAD") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
