...
<<>>
ALTER TABLE "FLASHLIGHT"."LOCKINFO" ADD CONSTRAINT "LOCKINFO_PK" PRIMARY KEY ("LOCK", "TYPE", "INTHREAD")
<<>>
-- foreign
...
<<>>
ALTER TABLE "FLASHLIGHT"."DOUBLELOCKEDMETHODS" ADD CONSTRAINT "DOUBLELOCKEDMETHODS_LOCK_FK" FOREIGN KEY ("LOCK") REFERENCES "FLASHLIGHT"."OBJECT" ("ID")
<<>>
ALTER TABLE "FLASHLIGHT"."DOUBLELOCKEDMETHODS" ADD CONSTRAINT "DOUBLELOCKEDMETHODS_INCLASS_FK" FOREIGN KEY ("INCLASS") REFERENCES "FLASHLIGHT"."OBJECT" ("ID")
<<>>
