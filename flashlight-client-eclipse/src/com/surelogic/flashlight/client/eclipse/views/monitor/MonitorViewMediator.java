...
public class MonitorViewMediator {
  ...
  MonitorViewMediator(final Composite status, final Label statusImage, final Label runText, final Label startTimeText,
      final Text fieldsSelector, final Button fieldsButton, final Tree fieldsTree, final Tree locksTree, final Text edtSelector,
      final Button edtButton, final Tree edtTree, final TextViewer listing) {
    f_status = status;
  ...
  private class SpecListener implements SelectionListener, ModifyListener {
    ...
    public void widgetSelected(final SelectionEvent e) {
      final Job job = EclipseUtility.toEclipseJob(new SendCommandToFlashlightMonitorJob(f_monitorStatus, String.format("set %s=%s",
          f_specType, f_widget.getText())));
      job.setSystem(true);
      job.schedule();
