...
public interface StoreListener {
   ...
   */
  void instanceFieldAccess(final boolean read, final Object receiver, final int fieldID, final long siteId,
   ...
   *          is non- null} then this is null} .
   */
  void staticFieldAccess(final boolean read, final int fieldID, final long siteId, final ClassPhantomReference dcPhantom,
   ...
   */
  void arrayAccess(final boolean read, final Object receiver, final int index, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void constructorExecution(final boolean before, final Object receiver, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void methodCall(final boolean before, final Object receiver, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void beforeIntrinsicLockAcquisition(final Object lockObject, final boolean lockIsThis, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void afterIntrinsicLockAcquisition(final Object lockObject, boolean lockIsThis, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void intrinsicLockWait(final boolean before, final Object lockObject, boolean lockIsThis, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void afterIntrinsicLockRelease(final Object lockObject, boolean lockIsThis, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void beforeUtilConcurrentLockAcquisitionAttempt(final Object lockObject, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void afterUtilConcurrentLockAcquisitionAttempt(final boolean gotTheLock, final Object lockObject, final long siteId);
   ...
   *          the line number where the event occurred.
   */
  void afterUtilConcurrentLockReleaseAttempt(final boolean releasedTheLock, final Object lockObject, final long siteId);
  ...
  void instanceFieldInit(final Object receiver, final int fieldId, final Object value);

  void staticFieldInit(final int fieldId, final Object value);

  /**
   * This event is called periodically to report all recently garbage collected
   * objects. Listeners are *not* required to be non-blocking, but they should
   * process data in a timely fashion, as the phantom reference queue will not
   * be polled again until this completes.
   *
   * @param references
   ...
   * @param nanoTime
   */
  void happensBeforeThread(final String id, final Thread callee, final long siteId, final String typeName, long nanoTime);
   ...
   * @param nanoTime
   */
  void happensBeforeObject(final String id, final Object object, final long siteId, final String typeName, long nanoTime);
   ...
   * @param nanoTime
   */
  void happensBeforeCollection(final String id, final Object collection, final Object item, final long siteId,
      final String typeName, long nanoTime);

  void happensBeforeExecutor(final String id, final Object object, final long siteId, final String typeName, final long nanoTime);
}
