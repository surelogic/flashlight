...
public final class Raw implements IRunDescription {
    ...
    public static final String DEFAULT_FLASHLIGHT_DATA_LOCATION = System.getProperty("user.home") + System.getProperty("file.separator") + ".flashlight-data";
    ...
    public static class Builder {
                ...
                for (File f : dataFiles) {
                    try {
                        ...
                        SLLogger.getLogger().log(
                                Level.WARNING,
                                "Failure during examination of raw data files. " + "Perhaps due to permissions or concurrent operations.",
                                e);
                    }
                }
            }
        ...
        private void add(final File dataFile, final List<Raw> mutableResult)
            ...
            if (dataFile == null || !dataFile.exists()) {
                SLLogger.getLogger().log(
                        Level.WARNING,
                        "Data file " + (dataFile == null ? "Unknown" : dataFile.getName()) + " does not exist.");
                return;
            }
            ...
            try {
                ...
                if (!logFile.exists()) {
                    SLLogger.getLogger().log(
                            Level.WARNING,
                            "No log file found for " + dataFile.getName() + ".");
                    return;
                }
                ...
                try {
                    ...
                    if (!e.getMessage().equals("done")) {
                        SLLogger.getLogger().log(
                                Level.WARNING,
                                "XML parsing problem reading header of data file " + dataFile.getName() + ".");
                        throw new SAXException(e);
                    }
                }
                ...
                if (handler.isWellFormed()) {
                    ...
                    SLLogger.getLogger().log(
                            Level.WARNING,
                            "Incomplete information read from " + dataFile.getName() + ".");
                }
            } finally {
                stream.close();
            }
