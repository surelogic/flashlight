...
<<>>
CREATE TABLE "FLASHLIGHT"."HAPPENSBEFOREVOLATILEREAD"("ACCESS" BIGINT NOT NULL, "TS" TIMESTAMP NOT NULL, "INTHREAD" BIGINT NOT NULL)
<<>>
CREATE TABLE "FLASHLIGHT"."HAPPENSBEFOREVOLATILEWRITE"("ACCESS" BIGINT NOT NULL, "TS" TIMESTAMP NOT NULL, "INTHREAD" BIGINT NOT NULL)
<<>>
-- ----------------------------------------------
