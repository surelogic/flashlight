...
<<>>
ALTER TABLE "FLASHLIGHT"."UCLOCK" DROP CONSTRAINT "UCLOCK_LOCK_FK"
<<>>
ALTER TABLE "FLASHLIGHT"."UCLOCK" DROP CONSTRAINT "UCLOCK_INCLASS_FK"
<<>>
ALTER TABLE "FLASHLIGHT"."UCLOCK" DROP CONSTRAINT "UCLOCK_INTHREAD_FK"
<<>>
ALTER TABLE "FLASHLIGHT"."UCLOCK" DROP CONSTRAINT "UCLOCK_RUN_FK"
<<>>
...
<<>>
ALTER TABLE "FLASHLIGHT"."TRACE" DROP CONSTRAINT "TRACE_INCLASS_FK"
<<>>
...
<<>>
ALTER TABLE "FLASHLIGHT"."UCLOCK" DROP PRIMARY KEY
<<>>
...
<<>>
DROP INDEX "FLASHLIGHT"."OBJECT_FLAG_INDEX"
<<>>
