...
public class AlertSpec {
  ...
  AlertSpec(final FieldDefs defs) {
    this(System.getProperty("com.surelogic.swingFieldAlerts", ""), System.getProperty("com.surelogic.sharedFieldAlerts", ""),
        System.getProperty("com.surelogic.lockSetAlerts", ""), defs);
  }

  AlertSpec(final String edtFields, final String sharedFields, final String lockSetFields, final FieldDefs defs) {
    ...
    final Pattern edtPattern = Pattern.compile(edtFields == null ? "" : edtFields);
    final Pattern sharedFieldPattern = Pattern.compile(sharedFields == null ? "" : sharedFields);
    final Pattern lockSetPattern = Pattern.compile(lockSetFields == null ? "" : lockSetFields);
  ...
  public AlertSpec merge(final AlertSpec spec) {
    final String newEdt = spec.edtFields == null ? edtFields : spec.edtFields;
    final String newShared = spec.sharedFields == null ? sharedFields : spec.sharedFields;
    final String newLockSet = spec.lockSetFields == null ? lockSetFields : spec.lockSetFields;
