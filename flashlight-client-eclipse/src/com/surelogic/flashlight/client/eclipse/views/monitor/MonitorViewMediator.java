...
public class MonitorViewMediator {
    ...
    MonitorViewMediator(final Composite status, final Label statusImage,
            final Label runText, final Text fieldsSelector,
            final Button fieldsButton, final Tree fieldsTree,
            final Tree locksTree, final Text edtSelector,
    ...
    private class SpecListener implements SelectionListener, ModifyListener {
        ...
        public void widgetSelected(final SelectionEvent e) {
            final Job job = EclipseUtility
                    .toEclipseJob(new SendCommandToFlashlightMonitorJob(
                            f_monitorStatus, String.format("set %s=%s",
