...
<<>>
CREATE TABLE "FLASHLIGHT"."FIELDBLOCKSTATS" ("RECEIVER" BIGINT NOT NULL, "FIELD" BIGINT NOT NULL, RFIELD BIGINT NOT NULL, "INTHREAD" BIGINT NOT NULL, "START" TIMESTAMP NOT NULL, "STOP" TIMESTAMP NOT NULL, "READS" BIGINT NOT NULL, "WRITES" BIGINT NOT NULL, "QUOTIENT" DECIMAL (4,2) NOT NULL)
<<>>
