...
<<>>
CREATE TABLE "FLASHLIGHT"."FIELDINSTANCELOCKSET" ("FIELD" BIGINT NOT NULL, "RECEIVER" BIGINT NOT NULL, "LOCK" BIGINT NOT NULL, "TYPE" CHAR(1) NOT NULL)
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKDURATION" ("ID" BIGINT NOT NULL GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1), "INTHREAD" BIGINT NOT NULL, "LOCK" BIGINT NOT NULL, "TYPE" CHAR(1) NOT NULL, "START" TIMESTAMP NOT NULL, "STARTEVENT" BIGINT NOT NULL, "STARTTRACE" BIGINT, "STOP" TIMESTAMP NOT NULL, "STOPEVENT" BIGINT NOT NULL, "STOPTRACE" BIGINT , "DURATION" BIGINT NOT NULL, "STATE" VARCHAR(10) NOT NULL)
<<>>
...
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKSHELD" ("LOCKEVENT" BIGINT NOT NULL, "LOCKHELDEVENT" BIGINT NOT NULL, "LOCKHELD" BIGINT NOT NULL, "LOCKHELDTYPE" CHAR(1) NOT NULL, "LOCKACQUIRED" BIGINT NOT NULL, "LOCKACQUIREDTYPE" CHAR(1) NOT NULL, "INTHREAD" BIGINT NOT NULL)
<<>>
...
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKCYCLE" ("COMPONENT" INTEGER NOT NULL, "LOCKHELD" BIGINT NOT NULL, "LOCKHELDTYPE" CHAR(1) NOT NULL, "LOCKACQUIRED" BIGINT NOT NULL, "LOCKACQUIREDTYPE" CHAR(1) NOT NULL, "COUNT" BIGINT NOT NULL, "FIRSTTIME" TIMESTAMP NOT NULL, "LASTTIME" TIMESTAMP NOT NULL)
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKCYCLETHREAD" ("COMPONENT" INTEGER NOT NULL, "LOCKHELD" BIGINT NOT NULL, "LOCKHELDTYPE" CHAR(1) NOT NULL, "LOCKACQUIRED" BIGINT NOT NULL, "LOCKACQUIREDTYPE" CHAR(1) NOT NULL, "THREAD" BIGINT NOT NULL, "COUNT" BIGINT NOT NULL, "FIRSTTIME" TIMESTAMP NOT NULL, "LASTTIME" TIMESTAMP NOT NULL)
<<>>
...
<<>>
CREATE TABLE "FLASHLIGHT"."SITE" ("ID" BIGINT NOT NULL, "ATLINE" INTEGER NOT NULL, "INCLASS" BIGINT NOT NULL, "INFILE" VARCHAR(255) NOT NULL, "LOCATION" VARCHAR(255) NOT NULL, "LOCATIONCODE" VARCHAR (11),"LOCATIONSPEC" VARCHAR(32672), "METHODCLASS" VARCHAR(32672), "METHODCALL" VARCHAR(255), "METHODSPEC" VARCHAR(32672), "METHODCODE" VARCHAR(11))
<<>>
...
<<>>
CREATE TABLE "FLASHLIGHT"."FIELDLOCKSET" ("FIELD" BIGINT NOT NULL, "LOCK" BIGINT NOT NULL, "TYPE" CHAR(1) NOT NULL)
<<>>
...
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKCOMPONENT" ("COMPONENT" BIGINT NOT NULL, "LOCK" BIGINT NOT NULL, "TYPE" CHAR(1) NOT NULL)
<<>>
...
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKTRACE" ("ID" BIGINT NOT NULL, "LOCK" BIGINT NOT NULL, "TRACE" BIGINT NOT NULL,  "TYPE" CHAR(1) NOT NULL, "PARENT" BIGINT)
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKPACKAGE" ("LOCK" BIGINT NOT NULL, "TYPE" CHAR(1) NOT NULL, "PACKAGES" BIGINT NOT NULL)
<<>>
CREATE TABLE "FLASHLIGHT"."LOCKINFO" ("LOCK" BIGINT NOT NULL, "TYPE" CHAR(1) NOT NULL,"INTHREAD" BIGINT NOT NULL, "COUNT" BIGINT, "DURATION" BIGINT NOT NULL, "AVERAGE" BIGINT NOT NULL, "INTRINSIC" CHAR(3), "JUC" CHAR(3), "MAXTYPES" BIGINT , "MAXPACKAGES" BIGINT)
<<>>
CREATE TABLE "FLASHLIGHT"."DOUBLELOCKEDMETHODS" ("LOCK" BIGINT NOT NULL, "TYPE" CHAR(1) NOT NULL, "INCLASS" BIGINT NOT NULL, "LOCATION" VARCHAR(255) NOT NULL,"LOCATIONSPEC" VARCHAR(32672), "LOCATIONCODE" VARCHAR (11))
<<>>
