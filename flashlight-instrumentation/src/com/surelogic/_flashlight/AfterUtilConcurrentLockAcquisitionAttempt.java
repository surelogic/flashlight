...
final class AfterUtilConcurrentLockAcquisitionAttempt extends UtilConcurrentLock {
  ...
  AfterUtilConcurrentLockAcquisitionAttempt(final boolean gotTheLock, final Lock lockObject, final long siteId,
