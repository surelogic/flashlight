ALTER TABLE "FLASHLIGHT"."ACCESS" DROP CONSTRAINT "ACCESS_TRACE_FK"
<<>>
...
<<>>
ALTER TABLE "FLASHLIGHT"."TRACE" DROP CONSTRAINT "TRACE_PARENT_FK"
<<>>
...
<<>>
ALTER TABLE "FLASHLIGHT"."LOCK" DROP CONSTRAINT "LOCK_TRACE_FK"
<<>>
