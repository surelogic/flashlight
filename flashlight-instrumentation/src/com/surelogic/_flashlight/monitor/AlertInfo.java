...
public final class AlertInfo {
  ...
  AlertInfo(final Set<FieldDef> edts, final Set<FieldDef> shared, final Set<FieldDef> lockSets) {
  ...
  /**
   * Returns the alerts that are in this object, but not in the given AlertInfo
   * object.
   * 
   * @param info
   * @return
  ...
  public AlertInfo alertsSince(final AlertInfo info) {
    ...
    final HashSet<FieldDef> shared = new HashSet<FieldDef>(sharedFieldViolations);
    final HashSet<FieldDef> lockSet = new HashSet<FieldDef>(lockSetViolations);
  ...
  public boolean isEmpty() {
    return edtViolations.isEmpty() && sharedFieldViolations.isEmpty() && lockSetViolations.isEmpty();
  }
