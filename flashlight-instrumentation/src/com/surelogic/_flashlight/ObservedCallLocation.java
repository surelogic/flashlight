...
public class ObservedCallLocation extends AbstractCallLocation {
  ...
  private ObservedCallLocation(final ClassPhantomReference withinClass, final int line, final long siteId) {
    super(siteId);
    f_withinClass = withinClass;
    f_line = line;
  }

  static ObservedCallLocation getInstance(final ClassPhantomReference withinClass, final int line,
