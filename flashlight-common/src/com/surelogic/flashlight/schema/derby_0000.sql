...
<<>>
CREATE TABLE "FLASHLIGHT"."HAPPENSBEFOREVOLATILEREAD"("FIELD" BIGINT NOT NULL, "TS" TIMESTAMP NOT NULL, "INTHREAD" BIGINT NOT NULL)
<<>>
CREATE TABLE "FLASHLIGHT"."HAPPENSBEFOREVOLATILEWRITE"("FIELD" BIGINT NOT NULL, "TS" TIMESTAMP NOT NULL, "INTHREAD" BIGINT NOT NULL)
<<>>
-- ----------------------------------------------
