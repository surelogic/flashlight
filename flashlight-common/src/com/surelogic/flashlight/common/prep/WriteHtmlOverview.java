...
public final class WriteHtmlOverview implements IPostPrep {
    ...
    public void doPostPrep(final Connection c, final SchemaData schema,
        ...
        fields.getSections().add(
                new FieldCoverageSection(info.getFields(), info.getThreads()));
        fields.getSections().add(
                ...
                for (LockSetLock lock : field.getLikelyLocks()) {
                    ...
                    for (Site s : lock.getNotHeldAt()) {
                        jNotHeldAt.object().object("site", "clazz",
                                ...
                                "location", s.getLocation(), "methodClass",
                                s.getMethodCallClass(), "methodName",
                                s.getMethodCallName());
                    }
        ...
        void writeThreadCoverage(final PrintWriter writer) throws IOException {
            ...
            for (Site s : sites) {
                jSites.object("clazz", s.getClazz(), "pakkage", s.getPackage(),
                        ...
                        s.getLocation(), "methodClass", s.getMethodCallClass(),
                        "methodName", s.getMethodCallName());
            }
            builder.build(writer);
        }
    ...
    private void loadJavaScript() {
        ...
        final URL jquery = loader
                .getResource("/com/surelogic/common/js/jquery-1.7.2.min.js");
        ...
        FileUtility
                .copy(jquery, new File(htmlDirectory, "jquery-1.7.2.min.js"));
