...
<<>>
CREATE INDEX "FLASHLIGHT"."HAPPENSBEFORECOLLSOURCE_TS_INDEX" ON "FLASHLIGHT"."HAPPENSBEFORECOLLSOURCE" ("TS")
<<>>
CREATE INDEX "FLASHLIGHT"."HAPPENSBEFORECOLLTARGET_TS_INDEX" ON "FLASHLIGHT"."HAPPENSBEFORECOLLTARGET" ("TS")
<<>>
CREATE INDEX "FLASHLIGHT"."HAPPENSBEFORESOURCE_TS_INDEX" ON "FLASHLIGHT"."HAPPENSBEFORESOURCE" ("TS")
<<>>
CREATE INDEX "FLASHLIGHT"."HAPPENSBEFORETARGET_TS_INDEX" ON "FLASHLIGHT"."HAPPENSBEFORETARGET" ("TS")
<<>>
-- ----------------------------------------------
...
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORESOURCE" ADD CONSTRAINT "HBS_TRACE_FK" FOREIGN KEY ("TRACE") REFERENCES "FLASHLIGHT"."TRACE" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORESOURCE" ADD CONSTRAINT "HBS_THREAD_FK" FOREIGN KEY ("INTHREAD") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORESOURCE" ADD CONSTRAINT "HBS_OBJECT_FK" FOREIGN KEY ("OBJ") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORETARGET" ADD CONSTRAINT "HBT_TRACE_FK" FOREIGN KEY ("TRACE") REFERENCES "FLASHLIGHT"."TRACE" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORETARGET" ADD CONSTRAINT "HBT_THREAD_FK" FOREIGN KEY ("INTHREAD") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORETARGET" ADD CONSTRAINT "HBT_OBJECT_FK" FOREIGN KEY ("OBJ") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORECOLLTARGET" ADD CONSTRAINT "HBCT_TRACE_FK" FOREIGN KEY ("TRACE") REFERENCES "FLASHLIGHT"."TRACE" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORECOLLTARGET" ADD CONSTRAINT "HBCT_THREAD_FK" FOREIGN KEY ("INTHREAD") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORECOLLTARGET" ADD CONSTRAINT "HBCT_OBJECT_FK" FOREIGN KEY ("OBJ") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORECOLLTARGET" ADD CONSTRAINT "HBCT_COLL_FK" FOREIGN KEY ("COLL") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORECOLLSOURCE" ADD CONSTRAINT "HBCS_TRACE_FK" FOREIGN KEY ("TRACE") REFERENCES "FLASHLIGHT"."TRACE" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORECOLLSOURCE" ADD CONSTRAINT "HBCS_THREAD_FK" FOREIGN KEY ("INTHREAD") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORECOLLSOURCE" ADD CONSTRAINT "HBCS_OBJECT_FK" FOREIGN KEY ("OBJ") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
ALTER TABLE "FLASHLIGHT"."HAPPENSBEFORECOLLSOURCE" ADD CONSTRAINT "HBCS_COLL_FK" FOREIGN KEY ("COLL") REFERENCES "FLASHLIGHT"."OBJECT" ("ID") ON DELETE NO ACTION ON UPDATE NO ACTION
<<>>
