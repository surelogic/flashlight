...
final class ObjectDefinition extends DefinitionalEvent {
  ...
  static class DefinitionVisitor extends IdPhantomReferenceVisitor {
    ...
    void visit(ClassPhantomReference r) {
      ...
      Entities.addAttribute(AttributeType.CLASS_NAME.label(), r.getName(), b);
      Entities.addAttribute(AttributeType.MODIFIER.label(), r.getModifiers(), b);
      Entities.addAttribute(AttributeType.CLASS_TYPE.label(), r.getType().getXmlName(), b);
      b.append("/>");
    }
    ...
    void visit(final ObjectDefinition defn, ObjectPhantomReference r) {
      ...
      Entities.addAttribute(AttributeType.ID.label(), r.getId(), b);
      Entities.addAttribute(AttributeType.TYPE.label(), defn.getType().getId(), b);
      b.append("/>");
    }
    ...
    void visit(final ObjectDefinition defn, ThreadPhantomReference r) {
      ...
      Entities.addAttribute(AttributeType.ID.label(), r.getId(), b);
      Entities.addAttribute(AttributeType.TYPE.label(), defn.getType().getId(), b);
      Entities.addAttribute(AttributeType.THREAD_NAME.label(), r.getName(), b);
      b.append("/>");
    }
